...
type RegisterUser struct {
	...
	Username string `json:"username" example:"sauki"`
	Password string `json:"password" example:"secret"`
	Email    string `json:"email" example:"saukiadillah@gmail.com"`
}
...
type UpdateUser struct {
	Email    string `json:"email" example:"newsaukiadillah@gmail.com"`
	Username string `json:"username" example:"sauki"`
}
